...
//                mHandler.obtainMessage(DSR_CHANGE).sendToTarget();
    ...
    // 设置分度值0.02kg 最大称量200kg
    public void setWeightConf02() {
//        sendMsg(new byte[]{0x02, 0x52, 0x5A, 0x52, 0x7F, (byte)0xFD, 0x0D});
        sendMsg(new byte[]{0x02, 0x53, 0x45, 0x54, 0x40, 0x20, 0x36, 0x30, 0x30, 0x2E, 0x30, 0x30, 0x67, 0x30, 0x31, 0x32, (byte)0xEB, 0x0D});
    }

    // 设置设分度值0.05kg 最大称量600kg
    public void setWeightConf05() {
//        sendMsg(new byte[]{0x02, 0x52, 0x5A, 0x52, 0x7F, (byte)0xFD, 0x0D});
        sendMsg(new byte[]{0x02, 0x53, 0x45, 0x54, 0x40, 0x20, 0x36, 0x30, 0x30, 0x2E, 0x30, 0x30, 0x68, 0x30, 0x31, 0x32, (byte)0xEB, 0x0D});
    }

    // 设置分度值0.1kg 最大称量600kg
    public void setWeightConf1() {
//        sendMsg(new byte[]{0x02, 0x52, 0x5A, 0x52, 0x7F, (byte)0xFD, 0x0D});
        sendMsg(new byte[]{0x02, 0x53, 0x45, 0x54, 0x40, 0x20, 0x36, 0x30, 0x30, 0x2E, 0x30, 0x30, 0x69, 0x30, 0x31, 0x32, (byte)0xEB, 0x0D});
    }

    // 设置标定25.00kg
    public void setWeightJiao() {
        sendMsg(new byte[]{0x02, 0x43, 0x41, 0x53, 0x7F, 0x20, 0x20, 0x32, 0x35, 0x2E, 0x30, 0x30, (byte) 0x8B, 0x0D});
    }

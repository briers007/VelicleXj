...
package com.minorfish.car.twoth.ui.upload.add;
...
public class BluetoothLeService extends Service {
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
            broadcastUpdate(ACTION_DATA_AVAILABLE, characteristic);
            Log.e("TTT", "onCharacteristicChanged");
        }
        ...
        public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, final int status) {
            ...
            Log.e("TTT", "onCharacteristicWrite  status = " + status);
            if (status == BluetoothGatt.GATT_SUCCESS) {
            ...
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    if (status == BluetoothGatt.GATT_SUCCESS) {
                        // Toast.makeText(BluetoothLeService.this, "写入成功", Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(BluetoothLeService.this, "写入失败 " + status, Toast.LENGTH_LONG).show();
                    }
                }
            });
        }

...
public class RvNew extends RvBaseWithSlideDelete<NewBean> {
...
//        return new RvBase.CustomAdapter(this.customSetItemLayoutId());
    ...
    @Override
    public void customConvert(final BaseViewHolder holder, NewBean bean) {

        holder.setText(R.id.tvType, ""+bean.typeName);
        holder
